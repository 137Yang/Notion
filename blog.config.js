...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leoy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个挣扎的凝聚态物理人🍚', // 作者简介

  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.leoy.uk', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Leoy, Blog', // 网站关键词 英文逗号隔开
